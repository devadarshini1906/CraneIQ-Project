                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text('Pro Plan', style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ),
              ],
    ...
    return Container(
      ...
      child: DropdownButtonFormField<String>(
        ...
        onChanged: (newValue) => setState(() {
          ...
          if (label == 'Brake Type') selectedBrake = newValue!;
          if (label == 'Date Range') selectedDateRange = newValue!;
        }),
