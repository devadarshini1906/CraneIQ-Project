          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: const [
                ...
                DataColumn(label: Text('Cranes', style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(label: Text('Generated On', style: TextStyle(fontWeight: FontWeight.bold))),
              ...
              rows: recentReports.map((report) {
                ...
                return DataRow(cells: [
                  ...
                  DataCell(Text(cranes)),
                  DataCell(Text(generatedOn)),
