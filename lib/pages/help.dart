...
import '../widgets/sidebar.dart'; // Ensure this points to the correct file
    ...
    return Builder(
      builder: (context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            icon: const Icon(Icons.menu, color: Color(0xFF1E90FF), size: 28),
            ...
            child: Column(
              ...
              children: [
                ...
                if (isMobile) ...[
                  const Text(
                    'Quick Help',
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Color(0xFF263244)),
                  ),
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          leading: Container(
            ...
            child: const Icon(Icons.help_outline, color: Color(0xFF1E90FF), size: 20),
          ),
          title: Text(
            question,
            style: const TextStyle(
    ...
    final List<Map<String, dynamic>> contactMethods = [
      {
        ...
        'subtitle': 'Typically responds within 2 business hours',
        'color': const Color(0xFF1E90FF),
      },
      {
