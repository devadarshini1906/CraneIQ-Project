    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        drawer: Sidebar(onItemSelected: (title) {
          ...
          switch (title) {
            case 'Dashboard':
              Navigator.pushReplacementNamed(context, '/dashboard'); // Use pushReplacement to avoid stack buildup
              break;
            case 'Help':
              Navigator.pushReplacementNamed(context, '/help'); // Use pushReplacement to avoid stack buildup
              break;
            case 'Rule Engine':
