  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      setState(() {
        _messages.add({
          'text':
              "🔧 MAXIM Assistant\n\nEnsure:\n• Flask server is running on laptop\n• Laptop & phone on same WiFi\n• Run: python app.py\n\nI'm ready to help with crane operations! 🏗",
          'isUser': false,
          'time': DateTime.now(),
        });
        _isLoading = false;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          return "🔄 MAXIM is learning! Try again!";
        }
      } else {
        return "💡 MAXIM Assistant: Ask me about crane safety and operations!";
      }
    } catch (e) {
